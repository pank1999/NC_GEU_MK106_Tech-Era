...
$user_check = "SELECT user_name from `result_part_1_graduation` where user_name = '$email' "
            ...
            <div class="col-xs-12">
                <div class="panel panel-success">
                    <div class="panel-heading">
                         ...
                         <h1 style="text-align: center;">Assignments-personality-1</h1>   
                    ...
                    <div class="panel-body">
                       ...
                       <div>
                        ...
                        <form action="check_personality_part_1.php" method="POST">
                        <?php
                        $connection= new mysqli('localhost:3308','root','','personality') or die(mysqli_error($connection));
                         
                        for($i=1;$i<9;$i++){ 
                        $q="SELECT * FROM question_part_1  where qid=$i";
