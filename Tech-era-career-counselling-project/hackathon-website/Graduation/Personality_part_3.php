...
$user_check = "SELECT user_name from `result_part_3_graduation` where user_name = '$email' "
            ...
            <div class="col-xs-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                         ...
                         <h1 style="text-align: center;">Assignments-personality-3</h1>   
                    ...
                    <div class="panel-body">
                       ...
                       <div>
                        ...
                        <form action="check_personality_part_3.php" method="POST">
                        <?php
                        $connection= new mysqli('localhost:3308','root','','personality') or die(mysqli_error($connection));
                         
                        for($i=1;$i<9;$i++){ 
                        $q="SELECT * FROM question_part_3 where qid=$i";
