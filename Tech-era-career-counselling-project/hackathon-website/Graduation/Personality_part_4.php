...
$user_check = "SELECT user_name from `result_part_4_graduation` where user_name = '$email' "
                    ...
                    <div class="panel-body">
                       ...
                       <?php 
                        ...
                        <div style="background-color:rgb(60, 114, 105); height:100px;">
                            <input type="submit" name="submit" value="submit" class="btn btn-success" style="margin-left:500px; margin-top:50px;;">
                         </div>
