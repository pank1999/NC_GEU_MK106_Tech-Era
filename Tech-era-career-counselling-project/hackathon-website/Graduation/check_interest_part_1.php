...
$assess_part1_result="INSERT INTO result_interest_class_g(email,Assessment,marks) VALUE ('$name','Job','$result')";
...
<div class="jumbotron" style="background-color:rgb(10, 221, 186);">
 ...
 <a href="http://localhost/phplessons/hackathon-website/Graduation/interest_part_2.php"> <button class="btn  btn-success " style="margin-left:500px; font-size:20px;">start</button>
