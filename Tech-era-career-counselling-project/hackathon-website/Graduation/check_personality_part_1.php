...
$_SESSION['P_1_g']=$result;

$name=$_SESSION['email'];
$query="INSERT INTO `result_part_1_graduation` ( `user_name`, `total_questions`, `correct_answer`) VALUES ( '$name', '10', '$result')";
...
$final_result="INSERT INTO personality_result_class_g ( `email`, `personality`, `marks`) VALUES ('$name','Set A','$result')";
...
<div class="jumbotron" style="background-color:skyblue;">
 ...
 <a href="http://localhost/phplessons/hackathon-website/Graduation/Personality_part_2.php"> <button class="btn btn-success  " style="margin-left:500px;font-size:20px; width:100px;">ok</button></a>
