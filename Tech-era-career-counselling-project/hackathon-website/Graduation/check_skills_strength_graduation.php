...
$connect= new mysqli('localhost:3308','root','','graduation') or die(mysqli_error($connet));
...
$_SESSION['skill_g']=$result;

$_SESSION['skills_G']=1;
$name=$_SESSION['email'];
$query="INSERT INTO `result_skills_graduation` ( `user_name`, `total_questions`, `correct_answer`) VALUES ( '$name', '10', '$result')";
...
<div class="jumbotron" style="background-color:skyblue;">
 ...
 <h1 style="text-align:center;">you have successfully completed your assessments </h1>
 <h2 style="text-align:center;">Thanks</h2>

 <a href="http://localhost/phplessons/hackathon-website/dashboard_graduation.php"> <button class="btn btn-success  " style="margin-left:470px;font-size:20px; width:100px;">Ok</button></a>
