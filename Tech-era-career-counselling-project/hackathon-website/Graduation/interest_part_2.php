...
$user_check = "SELECT user_name from `result_interest_part_2` where user_name = '$email' "
...
<head>
    ...
    <title>Assignments-interest_part_2 </title>
</head>
            ...
            <div class="col-xs-12">
                <div class="panel panel-success">
                    <div class="panel-heading">
                         ...
                         <h1 style="text-align: center;">Assignments-interest part -2</h1>   
                    ...
                    <div class="panel-body">
                       ...
                       <div>
                        ...
                        <form action="check_interest_part_2.php" method="POST">
                        <?php
                        $connection= new mysqli('localhost:3308','root','','graduation') or die(mysqli_error($connection));
                         
                        for($i=1;$i<11;$i++){ 
                        $q="SELECT * FROM question_interest_part_2  where qid=$i";
                        ...
                        <?php
                          ...
                          $q="SELECT * FROM answer_interest_part_2 where ans_id=$i ";
                          $query=mysqli_query($connection,$q);
