...
$user_check = "SELECT user_name from `result_interest_part_3` where user_name = '$email' "
...
<head>
    ...
    <title>Assignments-interest_part_3 </title>
</head>
...
<body>
    ...
    ?>
        ...
        <h3 style="color:black; margin-left:1000px;">progress bar</h3>              
                   <div class="progress">
                        <div class="progress-bar progress-bar-success" role="progressbar" style="width:66%;">
            ...
            <div class="col-xs-12">
                <div class="panel panel-success">
                    <div class="panel-heading">
                         ...
                         <h1 style="text-align: center;">Assignments-interest part -3</h1>   
                    ...
                    <div class="panel-body">
                       ...
                       <div>
                        ...
                        <form action="check_interst_part_3.php" method="POST">
                        <?php
                        $connection= new mysqli('localhost:3308','root','','graduation') or die(mysqli_error($connection));
                         
                        for($i=1;$i<11;$i++){ 
                        $q="SELECT * FROM question_interest_part_3  where qid=$i";
                        ...
                        <?php
                          ...
                          $q="SELECT * FROM answer_interest_part_3 where ans_id=$i ";
                          $query=mysqli_query($connection,$q);
