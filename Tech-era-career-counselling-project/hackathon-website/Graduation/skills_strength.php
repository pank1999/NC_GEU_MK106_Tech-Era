...
$user_check = "SELECT user_name from `result_skills_graduation` where user_name = '$email' "
...
<head>
    ...
    <title>skills and strength </title>
</head>
            ...
            <div class="col-xs-12">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                       ...
                       <p class="text-warning" style="float:right;"></p>
                       <div>
                        ...
                        <form action="check_skills_strength_graduation.php" method="POST">
                        <?php
