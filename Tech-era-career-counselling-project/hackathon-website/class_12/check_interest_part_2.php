...
$assess_part2_result="INSERT INTO result_interest_class_12(email,Assessment,marks) VALUE ('$name','commerce','$result')";
...
<div class="jumbotron" style="background-color:rgb(10, 221, 186);">
 ...
 <a href="http://localhost/phplessons/hackathon-website/class_12/interest_part_3.php"> <button class="btn  btn-success " style="margin-left:500px;">start</button>
