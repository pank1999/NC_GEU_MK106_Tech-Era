...
$_SESSION['result_personality_part_3']=$result;
$_SESSION['P_3_12']=$result;
$name=$_SESSION['email'];
$query="INSERT INTO `result_part_3_class_12` ( `user_name`, `total_questions`, `correct_answer`) VALUES ( '$name', '10', '$result')";
...
$final_result="INSERT INTO personality_result_class_12 ( `email`, `personality`, `marks`) VALUES ('$name','Set C','$result')";
...
<div class="jumbotron" style="background-color:skyblue;">
 ...
 <a href="http://localhost/phplessons/hackathon-website/class_12/Personality_part_4.php"> <button class="btn btn-success  " style="margin-left:500px;font-size:20px; width:100px;">ok</button></a>
