...
$_SESSION['result_personality_part_4']=$result;
$_SESSION['P_4_12']=$result;
$_SESSION['Personality4_12']=1;
$name=$_SESSION['email'];
$query="INSERT INTO `result_part_4_class_12` ( `user_name`, `total_questions`, `correct_answer`) VALUES ( '$name', '10', '$result')";
...
$final_result="INSERT INTO personality_result_class_12 ( `email`, `personality`, `marks`) VALUES ('$name','Set D','$result')";
...
<div class="jumbotron" style="background-color:skyblue;">
 ...
 <a href="http://localhost/phplessons/hackathon-website/dashboard_class_12.php"> <button class="btn btn-success  " style="margin-left:500px;font-size:20px; width:100px;">ok</button></a>
