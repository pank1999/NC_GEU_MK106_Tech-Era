...
$user_check = "SELECT user_name from `result_interest_part_1` where user_name = '$email' "
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                       ...
                       <div>
                        ...
                        <form action="check_interest_part_1.php" method="POST">
                        <?php
                        $connection= new mysqli('localhost:3308','root','','graduation') or die(mysqli_error($connection));
                         
                        for($i=1;$i<11;$i++){ 
                        $q="SELECT * FROM question_interest_part_1  where qid=$i";
