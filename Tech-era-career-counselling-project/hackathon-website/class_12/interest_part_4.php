...
$user_check = "SELECT user_name from `result_interest_part_4` where user_name = '$email' "
            ...
            <div class="col-xs-12">
                <div class="panel panel-success">
                    <div class="panel-heading">
                         ...
                         <h1 style="text-align: center;">Assignments-interest part -4</h1>   
                    ...
                    <div class="panel-body">
                       ...
                       <div>
                        ...
                        <form action="check_interest_part_4.php" method="POST">
                        <?php
                        $connection= new mysqli('localhost:3308','root','','class_12') or die(mysqli_error($connection));
                         
                        for($i=1;$i<11;$i++){ 
                        $q="SELECT * FROM question_interest_part_4  where qid=$i";
