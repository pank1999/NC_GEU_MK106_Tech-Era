...
$assess_part2_result="INSERT INTO result_interest_class_10(email,Assessment,marks) VALUE ('$name','commerce','$result')";
...
<div class="jumbotron" style="background-color:skyblue;">
 ...
 <a href="http://localhost/phplessons/hackathon-website/class_8_10_interest/Assignments_01_03.php"> <button class="btn btn-success " style="margin-left:500px; font-size:20px;">start</button>
