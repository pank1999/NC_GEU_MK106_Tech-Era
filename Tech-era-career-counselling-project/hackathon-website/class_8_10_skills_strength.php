...
$con= new mysqli("localhost:3308","root","","assignment_2") or die(mysqli_error($con));

$email=$_SESSION['email'];

$user_check = "SELECT user_name from `result_skills_class _8_10` where user_name = '$email' "
            ...
            <div class="col-xs-12">
                <div class="panel panel-success">
                    <div class="panel-heading">
                         ...
                         <h1 style="text-align: center;">Assignments-Skills & stregth</h1>   

                    </div>

                    <div class="panel-body">

                       <p class="text-warning" style="float:right;">total <br>question:20</p>
                       <div>
                        ...
                        <form action="check_8_10_skills_strength.php" method="POST">
                        <?php
                        $connection= new mysqli('localhost:3308','root','','assignment_2') or die(mysqli_error($connection));
                         
                        for($i=1;$i<11;$i++){ 
                        $q="SELECT * FROM question_quiz_assignment_2  where qid=$i";
                        ...
                        <?php
                          ...
                          $q="SELECT * FROM answer_quiz_assignment_2 where ans_id=$i ";
                          $query=mysqli_query($connection,$q);
